  ...
  return (
    <div className="flex flex-col justify-center items-center text-gray-900 bg-gradient-to-r from-primary-500 via-gray-100 to-primary-900 min-h-screen">
      <div className="max-w-[1248px] sm:mx-4 md:mx-6 lg:mx-[32px] xl:mx-[72px] mt-[120px] sm:mt-[80px] flex gap-4 flex-col">
        ...
        <Link className="border text-[22px] px-2 py-2 hover:text-primary-600 focus:text-green-900 rounded-md hover:bg-primary-10 focus:bg-primary-10 text-center" href={'/add-school'}>ADD SCHOOL</Link>
        <Link className="border text-[22px] px-2 py-2 hover:text-primary-600 focus:text-green-900 rounded-md hover:bg-primary-10 focus:bg-primary-10 text-center" href={'/show-schools'}>SHOW SCHOOLS</Link>
      </div>
    </div>
  );
};
